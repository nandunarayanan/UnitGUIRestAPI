    ...
    stages {
        ...
        stage('Build Management Execution'){
            steps {
                    ...
                    //sh label: '', script: '/home/bastin/UnitGUIRestAPI/UnitGUIRestAPI/testRobot/FileTransfer.sh'
            ...
            stage('Execution [class Level]'){
				steps {
				    parallel("Execute Google Test from [Host Server]":{
							...
							sh label: '', script: '/home/bastin/UnitGUIRestAPI/UnitGUIRestAPI/UnitTestFile/TestRunner/src/BotRun.sh'
						...
						"Execution of BOT level Testing":{
							...
							sh label: '', script: '/home/bastin/UnitGUIRestAPI/UnitGUIRestAPI/testRobot/ExecutionBot.sh'
            ...
            stage('Execution  [API]'){
				steps {
				    parallel("Execute Google Test from [Host Server]":{
							...
							sh label: '', script: '/home/bastin/UnitGUIRestAPI/UnitGUIRestAPI/UnitTestFile/TestRunner/src/ApiRun.sh'
						...
						"Execution of API level Testing":{
							...
							sh label: '', script: '/home/bastin/UnitGUIRestAPI/UnitGUIRestAPI/testRobot/ExecutionApi.sh'
